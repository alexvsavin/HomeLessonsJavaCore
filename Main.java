...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Dmitriy", Arrays.asList(new Course("Math"), new Course("Biology"),
                new Course("Testing"))));
        students.add(new Student("Alex", Arrays.asList(new Course("Math"), new Course("Geography"),
        ...
        students.add(new Student("Alena", Arrays.asList(new Course("Physics"), new Course("Testing"),
                new Course("Testing1"))));
